...
namespace LOTRAOM.CampaignBehaviors
{
    ...
    public class IsengardTextEvent
    {
        ...
        {
            new IsengardTextEvent("event1", "Oh no, only 90% time before isengard attacks", "continue", 0.9f),
            new IsengardTextEvent("event2", "Oh no, only 80% time before isengard attacks", "continue", 0.8f),
            new IsengardTextEvent("event3", "Oh no, only 60% time before isengard attacks", "continue", 0.6f),
            new IsengardTextEvent("event4", "Oh no, only 20% time before isengard attacks", "continue", 0.2f)
        };
    }
