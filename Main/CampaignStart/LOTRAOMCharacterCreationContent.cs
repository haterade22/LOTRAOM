...
namespace LOTRAOM.CampaignStart
{
    ...
    public class LOTRAOMCharacterCreationContent : SandboxCharacterCreationContent
    {
        ...
        {
            // FAMILY MENU
            CharacterCreationMenu parentsMenu = new(new("{=b4lDDcli}Family", null), new("{=XgFU1pCx}You were born into a family of...", null), new CharacterCreationOnInit(ParentsOnInit), CharacterCreationMenu.MenuTypes.MultipleChoice);


            // FAMILY MENU -> Dunland (EMPIRE)
            CharacterCreationCategory dunlandParentsCategory = parentsMenu.AddMenuCategory(EmpireParentsOnCondition);
            dunlandParentsCategory.AddCategoryOption(new("{=lotraom_dunland_1}Descendants of the Old Chieftains"), new() { DefaultSkills.Riding, DefaultSkills.Polearm }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, EmpireLandlordsRetainerOnConsequence, EmpireLandlordsRetainerOnApply, new("{=lotraom_dunland_desc_1}Your lineage traces back to the old chieftains of Dunland, proud leaders who stood against the encroachment of outsiders. Your father was a respected warrior and a trusted companion of the clan leader, riding at the forefront of battles to protect your people and their traditions."), null, 0, 0, 0, 0, 0);
            dunlandParentsCategory.AddCategoryOption(new("{=lotraom_dunland_2}Clan Merchants"), new() { DefaultSkills.Trade, DefaultSkills.Charm }, DefaultCharacterAttributes.Social, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, EmpireMerchantOnConsequence, EmpireMerchantOnApply, new("{=lotraom_dunland_desc_2}Your family traded goods within Dunland and beyond, bartering livestock, furs, and crafted items. They were skilled negotiators, often securing alliances and agreements that benefitted the clan."), null, 0, 0, 0, 0, 0);
            dunlandParentsCategory.AddCategoryOption(new("{=lotraom_dunland_3}Free Clansfolk"), new() { DefaultSkills.Athletics, DefaultSkills.Polearm }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, EmpireFreeholderOnConsequence, EmpireFreeholderOnApply, new("{=lotraom_dunland_desc_3}Your family were free clansfolk, tending to their modest herds and fields in the rugged lands of Dunland. They embodied the independence and resilience of your people, contributing to the strength and survival of the clan."), null, 0, 0, 0, 0, 0);
            dunlandParentsCategory.AddCategoryOption(new("{=lotraom_dunland_4}Skilled Artisans"), new() { DefaultSkills.Crafting, DefaultSkills.Crossbow }, DefaultCharacterAttributes.Intelligence, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, EmpireArtisanOnConsequence, EmpireArtisanOnApply, new("{=lotraom_dunland_desc_4}Your family were known for their craftsmanship, creating tools, weapons, and intricate carvings valued by the clan. Their work not only supported the community but also served as a source of pride and tradition."), null, 0, 0, 0, 0, 0);
            dunlandParentsCategory.AddCategoryOption(new("{=lotraom_dunland_5}Woodland Foragers"), new() { DefaultSkills.Scouting, DefaultSkills.Bow }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, EmpireWoodsmanOnConsequence, EmpireWoodsmanOnApply, new("{=lotraom_dunland_desc_5}Your family lived on the edge of the forest, relying on hunting, trapping, and foraging. They knew the wilderness intimately, navigating its dangers and resources with skill and caution."), null, 0, 0, 0, 0, 0);
            dunlandParentsCategory.AddCategoryOption(new("{=lotraom_dunland_6}Wanderers and Outcasts"), new() { DefaultSkills.Roguery, DefaultSkills.Throwing }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, EmpireVagabondOnConsequence, EmpireVagabondOnApply, new("{=lotraom_dunland_desc_6}Your family lived a transient life on the fringes of Dunland society, scraping by through odd jobs, hunting, or even thievery. They were resourceful survivors, adapting to the harsh realities of life in the shadow of more powerful realms."), null, 0, 0, 0, 0, 0);

            // FAMILY MENU -> Rohan (VLANDIAN)
            CharacterCreationCategory rohanParentsCategory = parentsMenu.AddMenuCategory(VlandianParentsOnCondition);
            rohanParentsCategory.AddCategoryOption(new("{=lotraom_rohan_1}Retainers of the Marshal"), new() { DefaultSkills.Riding, DefaultSkills.Polearm }, DefaultCharacterAttributes.Social, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, VlandiaBaronsRetainerOnConsequence, VlandiaBaronsRetainerOnApply, new("{=lotraom_rohan_desc_1}Your father was a loyal retainer to one of the Marshals of the Riddermark. He managed the lands of his lord, ensured the readiness of the local levy, and rode at the forefront of battle as a trusted warrior of the Mark."), null, 0, 0, 0, 0, 0);
            rohanParentsCategory.AddCategoryOption(new("{=lotraom_rohan_2}Merchants of Edoras"), new() { DefaultSkills.Trade, DefaultSkills.Charm }, DefaultCharacterAttributes.Intelligence, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, VlandiaMerchantOnConsequence, VlandiaMerchantOnApply, new("{=lotraom_rohan_desc_2}Your family traded goods in the bustling markets of Edoras, ensuring that the capital of the Riddermark thrived. They organized caravans, bartered with traders from Gondor and beyond, and were known for their fair dealings."), null, 0, 0, 0, 0, 0);
            rohanParentsCategory.AddCategoryOption(new("{=lotraom_rohan_3}Freeholders of the Westfold"), new MBList<SkillObject> { DefaultSkills.Polearm, DefaultSkills.Crossbow }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, VlandiaYeomanOnConsequence, VlandiaYeomanOnApply, new("{=lotraom_rohan_desc_3}Your family tilled the fertile lands of the Westfold, growing crops and raising livestock. As free folk, they were the backbone of Rohan’s strength, providing food and warriors for the kingdom's defense."), null, 0, 0, 0, 0, 0);
            rohanParentsCategory.AddCategoryOption(new("{=lotraom_rohan_4}Smiths of Aldburg"), new MBList<SkillObject> { DefaultSkills.Crafting, DefaultSkills.TwoHanded }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, VlandiaBlacksmithOnConsequence, VlandiaBlacksmithOnApply, new("{=lotraom_rohan_desc_4}Your family were renowned smiths in Aldburg, crafting weapons and armor for the warriors of the Riddermark. Your father’s skill with the forge was matched only by his dedication to the defense of Rohan."), null, 0, 0, 0, 0, 0);
            rohanParentsCategory.AddCategoryOption(new("{=lotraom_rohan_5}Hunters of the Eastfold"), new MBList<SkillObject> { DefaultSkills.Scouting, DefaultSkills.Crossbow }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, VlandiaHunterOnConsequence, VlandiaHunterOnApply, new("{=lotraom_rohan_desc_5}Your family lived on the edge of the Eastfold, relying on their skill with bow and blade to provide for themselves. They were skilled hunters and trackers, navigating the rolling plains and dense woods with ease."), null, 0, 0, 0, 0, 0);
            rohanParentsCategory.AddCategoryOption(new("{=lotraom_rohan_6}Wanderers of the Wold"), new MBList<SkillObject> { DefaultSkills.Roguery, DefaultSkills.Crossbow }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, VlandiaMercenaryOnConsequence, VlandiaMercenaryOnApply, new("{=lotraom_rohan_desc_6}Your father was a wanderer, traveling across the Wold and beyond. Known for his cunning and resourcefulness, he often worked as a scout or tracker for passing merchants, and sometimes dealt with less savory elements in the borderlands."), null, 0, 0, 0, 0, 0);

            // FAMILY MENU -> Dale (STURGIAN)
            CharacterCreationCategory daleParentsCategory = parentsMenu.AddMenuCategory(SturgianParentsOnCondition);
            daleParentsCategory.AddCategoryOption(new("{=lotraom_dale_1}Servants of the King of Dale"), new() { DefaultSkills.Riding, DefaultSkills.TwoHanded }, DefaultCharacterAttributes.Social, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, SturgiaBoyarsCompanionOnConsequence, SturgiaBoyarsCompanionOnApply, new("{=lotraom_dale_desc_1}Your family served the King of Dale, holding positions of respect and authority in the court. They trained with the king’s guards and rode alongside the royal retinue, ensuring the safety of the realm."), null, 0, 0, 0, 0, 0);
            daleParentsCategory.AddCategoryOption(new("{=lotraom_dale_2}Urban traders"), new MBList<SkillObject> { DefaultSkills.Trade, DefaultSkills.Tactics }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, SturgiaTraderOnConsequence, SturgiaTraderOnApply, new("{=lotraom_dale_desc_2}Your family were merchants in Dale, organizing trade with Erebor and distant lands. They brought prosperity to the city by mastering the art of negotiation and securing rare goods."), null, 0, 0, 0, 0, 0);
            daleParentsCategory.AddCategoryOption(new("{=lotraom_dale_3}Free Farmers"), new() { DefaultSkills.Athletics, DefaultSkills.Polearm }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, SturgiaFreemanOnConsequence, SturgiaFreemanOnApply, new("{=lotraom_dale_desc_3}Your family were hard-working farmers cultivating the fertile lands near the Running River, providing food for the city and its defenders."), null, 0, 0, 0, 0, 0);
            daleParentsCategory.AddCategoryOption(new("{=lotraom_dale_4}Urban artisans"), new() { DefaultSkills.Crafting, DefaultSkills.OneHanded }, DefaultCharacterAttributes.Intelligence, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, SturgiaArtisanOnConsequence, SturgiaArtisanOnApply, new("{=lotraom_dale_desc_4}Your family were skilled artisans of Dale, crafting weapons, armor, and tools of remarkable quality for the city and its allies."), null, 0, 0, 0, 0, 0);
            daleParentsCategory.AddCategoryOption(new("{=lotraom_dale_5}Forest Hunters"), new() { DefaultSkills.Scouting, DefaultSkills.Bow }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, SturgiaHunterOnConsequence, SturgiaHunterOnApply, new("{=lotraom_dale_desc_5}Your family lived on the forest fringes, hunting deer and gathering herbs. They were adept at tracking and survival, skills passed down through generations."), null, 0, 0, 0, 0, 0);
            daleParentsCategory.AddCategoryOption(new("{=lotraom_dale_6}Vagabonds"), new() { DefaultSkills.Roguery, DefaultSkills.Throwing }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, SturgiaVagabondOnConsequence, SturgiaVagabondOnApply, new("{=lotraom_dale_desc_6}Your family lived in the outskirts of Dale, scraping by with odd jobs. Sometimes they fell in with less savory elements, learning the underbelly of city life."), null, 0, 0, 0, 0, 0);

            // FAMILY MENU -> Harad (ASERAI)
            CharacterCreationCategory haradParentsCategory = parentsMenu.AddMenuCategory(AseraiParentsOnCondition);
            haradParentsCategory.AddCategoryOption(new("{=lotraom_harad_1}Allies of the Black Serpent"), new() { DefaultSkills.Riding, DefaultSkills.Throwing }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, AseraiTribesmanOnConsequence, AseraiTribesmanOnApply, new("{=lotraom_harad_desc_1}Your family were trusted allies of the Black Serpent, sworn to fight for the Haradrim and uphold their ancient oaths to the Dark Lord."), null, 0, 0, 0, 0, 0);
            haradParentsCategory.AddCategoryOption(new("{=lotraom_harad_2}Desert Warriors"), new() { DefaultSkills.Riding, DefaultSkills.Polearm }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, AseraiWariorSlaveOnConsequence, AseraiWariorSlaveOnApply, new("{=lotraom_harad_desc_2}Your father served as a warrior of Harad, a fierce and loyal soldier skilled in mounted combat and the use of deadly polearms."), null, 0, 0, 0, 0, 0);
            haradParentsCategory.AddCategoryOption(new("{=lotraom_harad_3}Traders of the South"), new() { DefaultSkills.Trade, DefaultSkills.Charm }, DefaultCharacterAttributes.Social, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, AseraiMerchantOnConsequence, AseraiMerchantOnApply, new("{=lotraom_harad_desc_3}Your family were traders who carried exotic goods like spices, ivory, and silks across the vast deserts and into distant lands."), null, 0, 0, 0, 0, 0);
            haradParentsCategory.AddCategoryOption(new("{=lotraom_harad_4}Desert Farmers"), new() { DefaultSkills.Athletics, DefaultSkills.OneHanded }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, AseraiOasisFarmerOnConsequence, AseraiOasisFarmerOnApply, new("{=lotraom_harad_desc_4}Your family cultivated crops and date palms in an oasis, ensuring their survival through careful irrigation and unyielding labor."), null, 0, 0, 0, 0, 0);
            haradParentsCategory.AddCategoryOption(new("{=lotraom_harad_5}Nomadic Tribespeople"), new() { DefaultSkills.Scouting, DefaultSkills.Bow }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, AseraiBedouinOnConsequence, AseraiBedouinOnApply, new("{=lotraom_harad_desc_5}Your family roamed the deserts, herding camels and goats, and living in harmony with the unforgiving land."), null, 0, 0, 0, 0, 0);
            haradParentsCategory.AddCategoryOption(new("{=lotraom_harad_6}Desert Outlaws"), new() { DefaultSkills.Roguery, DefaultSkills.Polearm }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, AseraiBackAlleyThugOnConsequence, AseraiBackAlleyThugOnApply, new("{=lotraom_harad_desc_6}Your family survived on the fringes of Harad society, taking what they could by force or cunning. They were feared and respected as desert outlaws."), null, 0, 0, 0, 0, 0);

            // FAMILY MENU -> Khand (BATTANIAN)
            CharacterCreationCategory khandParentsCategory = parentsMenu.AddMenuCategory(new(BattanianParentsOnCondition));
            khandParentsCategory.AddCategoryOption(new("{=lotraom_khand_1}Horse-Lords of Khand"), new() { DefaultSkills.Riding, DefaultSkills.Polearm }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, BattaniaChieftainsHearthguardOnConsequence, BattaniaChieftainsHearthguardOnApply, new("{=lotraom_khand_desc_1}Your family were part of the ruling elite of Khand, known for their prowess on horseback and mastery of cavalry warfare."), null, 0, 0, 0, 0, 0);
            khandParentsCategory.AddCategoryOption(new("{=lotraom_khand_2}Nomadic Healers"), new() { DefaultSkills.Medicine, DefaultSkills.Charm }, DefaultCharacterAttributes.Intelligence, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, BattaniaHealerOnConsequence, BattaniaHealerOnApply, new("{=lotraom_khand_desc_2}Your parents were healers among the clans of Khand, using herbs and rituals to cure the sick and uphold ancient traditions."), null, 0, 0, 0, 0, 0);
            khandParentsCategory.AddCategoryOption(new("{=lotraom_khand_3}Clan Warriors"), new() { DefaultSkills.Athletics, DefaultSkills.Throwing }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, BattaniaTribesmanOnConsequence, BattaniaTribesmanOnApply, new("{=lotraom_khand_desc_3}Your family were warriors of Khand, fighting fiercely to protect their land and their clan's honor."), null, 0, 0, 0, 0, 0);
            khandParentsCategory.AddCategoryOption(new("{=lotraom_khand_4}Smiths of the Steppes"), new() { DefaultSkills.Crafting, DefaultSkills.TwoHanded }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, BattaniaSmithOnConsequence, BattaniaSmithOnApply, new("{=lotraom_khand_desc_4}Your family were renowned smiths, crafting deadly weapons and ornate armor that symbolized the strength of Khand."), null, 0, 0, 0, 0, 0);
            khandParentsCategory.AddCategoryOption(new("{=lotraom_khand_5}Steppe Hunters"), new() { DefaultSkills.Scouting, DefaultSkills.Tactics }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, BattaniaWoodsmanOnConsequence, BattaniaWoodsmanOnApply, new("{=lotraom_khand_desc_5}Your family survived on the steppe, hunting game and mastering the art of tracking and ambush."), null, 0, 0, 0, 0, 0);
            khandParentsCategory.AddCategoryOption(new("{=lotraom_khand_6}Bards of Khand"), new() { DefaultSkills.Roguery, DefaultSkills.Charm }, DefaultCharacterAttributes.Social, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, BattaniaBardOnConsequence, BattaniaBardOnApply, new("{=lotraom_khand_desc_6}Your father was a bard, keeping the stories and songs of Khand alive to inspire and unite the clans."), null, 0, 0, 0, 0, 0);


            // FAMILY MENU -> Easterling (KHUZAIT)
            CharacterCreationCategory easterlingParentsCategory = parentsMenu.AddMenuCategory(new(KhuzaitParentsOnCondition));
            easterlingParentsCategory.AddCategoryOption(new("{=lotraom_easterling_1}Kinsfolk of the Chieftain"), new() { DefaultSkills.Riding, DefaultSkills.Polearm }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, KhuzaitNoyansKinsmanOnConsequence, KhuzaitNoyansKinsmanOnApply, new("{=lotraom_easterling_desc_1}Your family were close relatives of the ruling chieftain. Your father was a trusted advisor and warrior, fighting as an armored lancer, while your mother helped manage the affairs of the clan."), null, 0, 0, 0, 0, 0);
            easterlingParentsCategory.AddCategoryOption(new("{=lotraom_easterling_2}Merchants of the East"), new() { DefaultSkills.Trade, DefaultSkills.Charm }, DefaultCharacterAttributes.Social, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, KhuzaitMerchantOnConsequence, KhuzaitMerchantOnApply, new("{=lotraom_easterling_desc_2}Your family controlled trade caravans across the eastern steppes, bringing silks, spices, and fine wares from distant lands to the cities of Rhûn. Their dealings earned respect and wealth within the region."), null, 0, 0, 0, 0, 0);
            easterlingParentsCategory.AddCategoryOption(new("{=lotraom_easterling_3}Nomadic Tribesfolk"), new() { DefaultSkills.Bow, DefaultSkills.Riding }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, KhuzaitTribesmanOnConsequence, KhuzaitTribesmanOnApply, new("{=lotraom_easterling_desc_3}Your family belonged to a nomadic clan, tending herds of horses and cattle across the vast steppes. They were known for their marksmanship and their skill as mounted warriors."), null, 0, 0, 0, 0, 0);
            easterlingParentsCategory.AddCategoryOption(new("{=lotraom_easterling_4}Steppe Farmers"), new() { DefaultSkills.Polearm, DefaultSkills.Throwing }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, KhuzaitFarmerOnConsequence, KhuzaitFarmerOnApply, new("{=lotraom_easterling_desc_4}Your family cultivated fertile patches of land on the steppes, growing wheat and barley for the clans. They were also part of the levied forces, wielding spears and shields in defense of their kin."), null, 0, 0, 0, 0, 0);
            easterlingParentsCategory.AddCategoryOption(new("{=lotraom_easterling_5}Spirit Callers"), new() { DefaultSkills.Medicine, DefaultSkills.Charm }, DefaultCharacterAttributes.Intelligence, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, KhuzaitShamanOnConsequence, KhuzaitShamanOnApply, new("{=lotraom_easterling_desc_5}Your family were spiritual guides, channeling the will of the spirits through rituals and ancient songs. They healed the wounded and advised the clans on matters of tradition and strategy."), null, 0, 0, 0, 0, 0);
            easterlingParentsCategory.AddCategoryOption(new("{=lotraom_easterling_6}Outland Scouts"), new() { DefaultSkills.Scouting, DefaultSkills.Riding }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, KhuzaitNomadOnConsequence, KhuzaitNomadOnApply, new("{=lotraom_easterling_desc_6}Your family lived on the fringes of the great steppe, acting as scouts and trackers for the clans. They were experts at navigating the wilderness and evading pursuers in hostile terrain."), null, 0, 0, 0, 0, 0);

            // Gondor
            CharacterCreationCategory gondorParentsCategory = parentsMenu.AddMenuCategory(new(GondorParentsOnCondition));
            gondorParentsCategory.AddCategoryOption(new("{=lotraom_gondor_1}Noble Houses of Gondor"), new() { DefaultSkills.TwoHanded, DefaultSkills.Riding }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, (characterCreation) => { SetParentAndOccupationType(characterCreation, 1, OccupationTypes.Retainer); }, EmpireLandlordsRetainerOnApply, new("{=lotraom_gondor_desc_1}Your family belonged to one of Gondor's noble houses, sworn to defend the White Tree. Your father was a knight who fought bravely in service to the Steward, while your mother managed the family’s lands and affairs."), null, 0, 0, 0, 0, 0);
            gondorParentsCategory.AddCategoryOption(new("{=lotraom_gondor_2}Merchants of the White City"), new() { DefaultSkills.Trade, DefaultSkills.Charm }, DefaultCharacterAttributes.Social, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, (characterCreation) => { SetParentAndOccupationType(characterCreation, 2, OccupationTypes.Merchant); }, EmpireMerchantOnApply, new("{=lotraom_gondor_desc_2}Your family were prosperous traders within Minas Tirith, dealing in fine goods and wares. Their influence within the city’s merchant guilds brought wealth and respect to your household."), null, 0, 0, 0, 0, 0);
            gondorParentsCategory.AddCategoryOption(new("{=lotraom_gondor_3}Farmers of the Pelennor"), new() { DefaultSkills.Athletics, DefaultSkills.Polearm }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, (characterCreation) => { SetParentAndOccupationType(characterCreation, 3, OccupationTypes.Farmer); }, EmpireFreeholderOnApply, new("{=lotraom_gondor_desc_3}Your family tilled the rich soil of the Pelennor Fields, providing sustenance for Minas Tirith. They also served as levy soldiers, standing in defense of the city during times of war."), null, 0, 0, 0, 0, 0);
            gondorParentsCategory.AddCategoryOption(new("{=lotraom_gondor_4}Artisans of Minas Tirith"), new() { DefaultSkills.Crafting, DefaultSkills.OneHanded }, DefaultCharacterAttributes.Intelligence, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, (characterCreation) => { SetParentAndOccupationType(characterCreation, 4, OccupationTypes.Artisan); }, EmpireArtisanOnApply, new("{=lotraom_gondor_desc_4}Your family were skilled craftsmen in Minas Tirith, creating fine armor, weapons, and tapestries that adorned the halls of the White City. Their artistry was renowned across Gondor."), null, 0, 0, 0, 0, 0);
            gondorParentsCategory.AddCategoryOption(new("{=lotraom_gondor_5}Rangers of Ithilien"), new() { DefaultSkills.Scouting, DefaultSkills.Bow }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, (characterCreation) => { SetParentAndOccupationType(characterCreation, 4, OccupationTypes.Hunter); }, EmpireWoodsmanOnApply, new("{=lotraom_gondor_desc_5}Your family were members of the Rangers of Ithilien, skilled in the arts of stealth and archery. They patrolled the wilds, protecting Gondor’s borders from the forces of Mordor."), null, 0, 0, 0, 0, 0);
            gondorParentsCategory.AddCategoryOption(new("{=lotraom_gondor_6}Street Urchins of Osgiliath"), new() { DefaultSkills.Roguery, DefaultSkills.Throwing }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, (characterCreation) => { SetParentAndOccupationType(characterCreation, 4, OccupationTypes.Vagabond); }, EmpireVagabondOnApply, new("{=lotraom_gondor_desc_6}Your family lived among the ruins of Osgiliath, surviving through cunning and resourcefulness. They scavenged what they could and occasionally served under Gondor’s banners as irregular troops."), null, 0, 0, 0, 0, 0);


            // Mordor
            CharacterCreationCategory mordorParentsCategory = parentsMenu.AddMenuCategory(new(MordorParentsOnCondition));
            mordorParentsCategory.AddCategoryOption(new("{=lotraom_mordor_1}Servants of the Dark Tower"), new() { DefaultSkills.Polearm, DefaultSkills.TwoHanded }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, (characterCreation) => { SetParentAndOccupationType(characterCreation, 1, OccupationTypes.Retainer); }, EmpireLandlordsRetainerOnApply, new("{=lotraom_mordor_desc_1}Your family served directly under the command of the Dark Tower. Your father was a brutal enforcer, while your mother worked to instill the will of Sauron among the lesser folk."), null, 0, 0, 0, 0, 0);
            mordorParentsCategory.AddCategoryOption(new("{=lotraom_mordor_2}Merchants of the Black Road"), new() { DefaultSkills.Trade, DefaultSkills.Roguery }, DefaultCharacterAttributes.Social, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, (characterCreation) => { SetParentAndOccupationType(characterCreation, 2, OccupationTypes.Merchant); }, EmpireMerchantOnApply, new("{=lotraom_mordor_desc_2}Your family managed trade and supplies within Mordor, ensuring the armies of Sauron were equipped for war. Their dealings were shadowed by intrigue and violence."), null, 0, 0, 0, 0, 0);
            mordorParentsCategory.AddCategoryOption(new("{=lotraom_mordor_3}Slaves of Barad-dûr"), new() { DefaultSkills.Athletics, DefaultSkills.OneHanded }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, (characterCreation) => { SetParentAndOccupationType(characterCreation, 3, OccupationTypes.Farmer); }, EmpireFreeholderOnApply, new("{=lotraom_mordor_desc_3}Your family were enslaved laborers, toiling in the forges and quarries of Mordor to fuel the war machine of the Dark Lord. Their resilience became a testament to their will to survive."), null, 0, 0, 0, 0, 0);
            mordorParentsCategory.AddCategoryOption(new("{=lotraom_mordor_4}Orc Taskmasters"), new() { DefaultSkills.Tactics, DefaultSkills.TwoHanded }, DefaultCharacterAttributes.Intelligence, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, (characterCreation) => { SetParentAndOccupationType(characterCreation, 4, OccupationTypes.Artisan); }, EmpireArtisanOnApply, new("{=lotraom_mordor_desc_4}Your family were tasked with overseeing the labor of Orcs and Men alike, ensuring that Sauron's orders were carried out with ruthless efficiency."), null, 0, 0, 0, 0, 0);
            mordorParentsCategory.AddCategoryOption(new("{=lotraom_mordor_5}Hunters of Gorgoroth"), new() { DefaultSkills.Scouting, DefaultSkills.Bow }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, (characterCreation) => { SetParentAndOccupationType(characterCreation, 5, OccupationTypes.Hunter); }, EmpireWoodsmanOnApply, new("{=lotraom_mordor_desc_5}Your family roamed the volcanic plains of Gorgoroth, hunting and tracking prey to sustain the armies of Mordor. Their skill in the wilderness was unmatched."), null, 0, 0, 0, 0, 0);
            mordorParentsCategory.AddCategoryOption(new("{=lotraom_mordor_6}Uruk Overseers"), new() { DefaultSkills.Roguery, DefaultSkills.Polearm }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, (characterCreation) => { SetParentAndOccupationType(characterCreation, 6, OccupationTypes.Vagabond); }, EmpireVagabondOnApply, new("{=lotraom_mordor_desc_6}Your family served as overseers for the Uruk-hai legions, enforcing discipline and maintaining order within Sauron’s ranks."), null, 0, 0, 0, 0, 0);


            // Rivendell
            CharacterCreationCategory rivendellParentsCategory = parentsMenu.AddMenuCategory(new(RivendellParentsOnCondition));
            rivendellParentsCategory.AddCategoryOption(new("{=lotraom_rivendell_1}Nobles of Imladris"), new() { DefaultSkills.TwoHanded, DefaultSkills.Riding }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, (characterCreation) => { SetParentAndOccupationType(characterCreation, 1, OccupationTypes.Retainer); }, EmpireLandlordsRetainerOnApply, new("{=lotraom_rivendell_desc_1}Your family were esteemed Elves of Imladris, sworn to serve Elrond. They carried the wisdom of ages and the strength to defend Rivendell in its time of need."), null, 0, 0, 0, 0, 0);
            rivendellParentsCategory.AddCategoryOption(new("{=lotraom_rivendell_2}Artisans of Rivendell"), new() { DefaultSkills.Crafting, DefaultSkills.Charm }, DefaultCharacterAttributes.Intelligence, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, (characterCreation) => { SetParentAndOccupationType(characterCreation, 2, OccupationTypes.Merchant); }, EmpireArtisanOnApply, new("{=lotraom_rivendell_desc_2}Your family were skilled craftsmen and loremasters, creating wonders of Elven craftsmanship and preserving the ancient knowledge of Middle-earth."), null, 0, 0, 0, 0, 0);
            rivendellParentsCategory.AddCategoryOption(new("{=lotraom_rivendell_3}Farmers of the Hidden Valley"), new() { DefaultSkills.Athletics, DefaultSkills.OneHanded }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, (characterCreation) => { SetParentAndOccupationType(characterCreation, 3, OccupationTypes.Farmer); }, EmpireFreeholderOnApply, new("{=lotraom_rivendell_desc_3}Your family tended the fertile fields of Rivendell, ensuring its people and guests were well-fed and sustained in their peaceful haven."), null, 0, 0, 0, 0, 0);
        ...
        {
            // CHILDHOOD MENU
            CharacterCreationMenu childhoodMenu = new(new("{=8Yiwt1z6}Early Childhood", null), new("{=character_creation_content_16}As a child you were noted for...", null), new CharacterCreationOnInit(ChildhoodOnInit), CharacterCreationMenu.MenuTypes.MultipleChoice);

            CharacterCreationCategory childhoodCategory = childhoodMenu.AddMenuCategory(null);
            childhoodCategory.AddCategoryOption(new("{=kmM68Qx4}your leadership skills."), new() { DefaultSkills.Leadership, DefaultSkills.Tactics }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, ChildhoodYourLeadershipSkillsOnConsequence, ChildhoodGoodLeadingOnApply, new("{=FfNwXtii}In the shadow of ancient ruins, your youthful band of companions looked to you for guidance. Whether charting a safe path through the woods or rallying courage against imagined foes, your natural leadership shone like the banners of the kings of old."), null, 0, 0, 0, 0, 0);
            childhoodCategory.AddCategoryOption(new("{=5HXS8HEY}your brawn."), new() { DefaultSkills.TwoHanded, DefaultSkills.Throwing }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, ChildhoodYourBrawnOnConsequence, ChildhoodGoodAthleticsOnApply, new("{=YKzuGc54}Your strength was the stuff of stories among the village children. They marveled at your ability to carry burdens like a seasoned warrior and hurl stones with the force of a trebuchet. Even then, you were compared to the heroes of legend."), null, 0, 0, 0, 0, 0);
            childhoodCategory.AddCategoryOption(new("{=QrYjPUEf}your attention to detail."), new() { DefaultSkills.Athletics, DefaultSkills.Bow }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, ChildhoodAttentionToDetailOnConsequence, ChildhoodGoodMemoryOnApply, new("{=JUSHAPnu}With keen eyes that missed no movement and quick feet that outran most, you were often the first to spot a deer trail or the glint of a hidden trinket. Your friends likened you to the rangers of the north, silent and observant."), null, 0, 0, 0, 0, 0);
            ...
            childhoodCategory.AddCategoryOption(new("{=GEYzLuwb}your way with people."), new() { DefaultSkills.Charm, DefaultSkills.Leadership }, DefaultCharacterAttributes.Social, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, ChildhoodWayWithPeopleOnConsequence, ChildhoodGoodMannersOnApply, new("{=w2TEQq26}You had a natural gift for understanding others, often diffusing arguments and winning friends with ease. Your elders said you had the charisma of an elven lord, while your peers followed you with unwavering loyalty."), null, 0, 0, 0, 0, 0);
            childhoodCategory.AddCategoryOption(new("{=MEgLE2kj}your skill with horses."), new() { DefaultSkills.Riding, DefaultSkills.Medicine }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, ChildhoodSkillsWithHorsesOnConsequence, ChildhoodAffinityWithAnimalsOnApply, new("{=ngazFofr}You felt a deep bond with animals, particularly horses. The stable hands marveled at how you could calm even the most spirited steed, and your skill in caring for wounds brought whispers that you might rival the horsemasters of Rohan one day."), null, 0, 0, 0, 0, 0);

            characterCreation.AddNewMenu(childhoodMenu);
        }
        protected new void AddEducationMenu(CharacterCreation characterCreation)
        {
            CharacterCreationMenu characterCreationMenu = new(new("{=rcoueCmk}Adolescence", null), _educationIntroductoryText, new CharacterCreationOnInit(EducationOnInit), CharacterCreationMenu.MenuTypes.MultipleChoice);

            // EDUCATION MENU -> RURAL
            CharacterCreationCategory educationCategory = characterCreationMenu.AddMenuCategory(null);
            educationCategory.AddCategoryOption(new("{=RKVNvimC}tended the flocks in the shadow of the mountains.", null), new() { DefaultSkills.Athletics, DefaultSkills.Throwing }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, RuralAdolescenceOnCondition, RuralAdolescenceHerderOnConsequence, RuralAdolescenceHerderOnApply, new("{=KfaqPpbK}Amid rolling hills and rocky outcroppings, you kept watch over the flocks, guarding them against wolves and wargs with your keen aim and steady vigilance."), null, 0, 0, 0, 0, 0);
            educationCategory.AddCategoryOption(new("learned the ancient craft of the forge.", null), new() { DefaultSkills.TwoHanded, DefaultSkills.Crafting }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, BattanianParentsOnCondition, RuralAdolescenceSmithyOnConsequence, RuralAdolescenceSmithyOnApply, new("{=y6j1bJTH}The forge was a place of glowing embers and the ringing of hammers. Under the guidance of a master smith, you learned to shape steel into tools, weapons, and symbols of your people's pride."), null, 0, 0, 0, 0, 0);
            educationCategory.AddCategoryOption(new("{=tI8ZLtoA}rebuilt and restored.", null), new() { DefaultSkills.Crafting, DefaultSkills.Engineering }, DefaultCharacterAttributes.Intelligence, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, RuralAdolescenceOnCondition, RuralAdolescenceRepairmanOnConsequence, RuralAdolescenceRepairmanOnApply, new("{=6LFj919J}In the aftermath of storms or skirmishes, you worked to mend fences, rebuild homes, and strengthen walls, leaving the village better defended than before."), null, 0, 0, 0, 0, 0);
            educationCategory.AddCategoryOption(new("{=TRwgSLD2}searched the woods for healing herbs.", null), new() { DefaultSkills.Medicine, DefaultSkills.Scouting }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, RuralAdolescenceOnCondition, RuralAdolescenceGathererOnConsequence, RuralAdolescenceGathererOnApply, new("{=9ks4u5cH}You wandered through ancient forests, learning the lore of plants and their medicinal properties. You carried back leaves and roots that could heal wounds and ease fever, saving many lives."), null, 0, 0, 0, 0, 0);
            educationCategory.AddCategoryOption(new("{=T7m7ReTq}tracked and hunted small prey.", null), new() { DefaultSkills.Bow, DefaultSkills.Tactics }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, RuralAdolescenceOnCondition, RuralAdolescenceHunterOnConsequence, RuralAdolescenceHunterOnApply, new("{=RuvSk3QT}With a bow in hand, you moved silently through the woods, learning to read the signs of the wild. Your skills as a tracker and hunter became second nature."), null, 0, 0, 0, 0, 0);
            educationCategory.AddCategoryOption(new("{=qAbMagWq}sold wares at the bustling market.", null), new() { DefaultSkills.Trade, DefaultSkills.Charm }, DefaultCharacterAttributes.Social, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, RuralAdolescenceOnCondition, RuralAdolescenceHelperOnConsequence, RuralAdolescenceHelperOnApply, new("{=DIgsfYfz}Amid the lively chatter and bartering of the marketplace, you haggled with traders from distant lands, learning both their stories and the art of negotiation."), null, 0, 0, 0, 0, 0);

            // EDUCATION MENU -> URBAN
            educationCategory.AddCategoryOption(new("{=nOfSqRnI}trained with the town guard.", null), new() { DefaultSkills.Crossbow, DefaultSkills.Tactics }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, UrbanAdolescenceOnCondition, UrbanAdolescenceWatcherOnConsequence, UrbanAdolescenceWatcherOnApply, new("{=qnqdEJOv}The clanging of shields and the twang of crossbows filled your days as you learned the discipline required to defend your town from the threats of the wider world."), null, 0, 0, 0, 0, 0);
            educationCategory.AddCategoryOption(new("{=8a6dnLd2}found your place among the shadowy guilds.", null), new() { DefaultSkills.Roguery, DefaultSkills.OneHanded }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, UrbanAdolescenceOnCondition, UrbanAdolescenceGangerOnConsequence, UrbanAdolescenceGangerOnApply, new("{=1SUTcF0J}The underbelly of the city became your domain, where alliances were forged in whispers, and survival demanded both cunning and steel."), null, 0, 0, 0, 0, 0);
            educationCategory.AddCategoryOption(new("{=7Hv984Sf}toiled at the docks and in the workshops.", null), new() { DefaultSkills.Athletics, DefaultSkills.Crafting }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, UrbanAdolescenceOnCondition, UrbanAdolescenceDockerOnConsequence, UrbanAdolescenceDockerOnApply, new("{=bhdkegZ4}You learned the value of hard work, whether unloading ships or repairing the stone walls of grand halls. Each day tested both your body and your resolve."), null, 0, 0, 0, 0, 0);
            educationCategory.AddCategoryOption(new("{=kbcwb5TH}worked among the merchants and traders.", null), new() { DefaultSkills.Trade, DefaultSkills.Charm }, DefaultCharacterAttributes.Social, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, UrbanPoorAdolescenceOnCondition, UrbanAdolescenceMarketerOnConsequence, UrbanAdolescenceMarketerOnApply, new("{=lLJh7WAT}The call of distant lands and the weight of precious goods taught you the ebb and flow of trade that held the realm together."), null, 0, 0, 0, 0, 0);
            educationCategory.AddCategoryOption(new("{=mfRbx5KE}devoured ancient tomes.", null), new() { DefaultSkills.Engineering, DefaultSkills.Leadership }, DefaultCharacterAttributes.Intelligence, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, UrbanPoorAdolescenceOnCondition, UrbanAdolescenceTutorOnConsequence, UrbanAdolescenceDockerOnApply, new("{=elQnygal}Through the pages of old lore, you glimpsed the triumphs and tragedies of ages past, gaining insight into the forces that shaped the world."), null, 0, 0, 0, 0, 0);
            educationCategory.AddCategoryOption(new("{=etG87fB7}studied under a wise mentor.", null), new() { DefaultSkills.Engineering, DefaultSkills.Leadership }, DefaultCharacterAttributes.Intelligence, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, UrbanRichAdolescenceOnCondition, UrbanAdolescenceTutorOnConsequence, UrbanAdolescenceDockerOnApply, new("{=hXl25avg}Under the guidance of a learned tutor, you honed your mind, delving into strategy, history, and the mysteries of the natural world."), null, 0, 0, 0, 0, 0);
            educationCategory.AddCategoryOption(new("{=FKpLEamz}cared for the steeds of kings.", null), new() { DefaultSkills.Riding, DefaultSkills.Steward }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, UrbanRichAdolescenceOnCondition, UrbanAdolescenceHorserOnConsequence, UrbanAdolescenceDockerOnApply, new("{=Ghz90npw}You gained a deep respect for the horses that carried warriors into battle and messengers across the realm, learning to understand their needs and their strength."), null, 0, 0, 0, 0, 0);
            educationCategory.AddCategoryOption(new("{=vH7GtuuK}worked in the stables.", null), new() { DefaultSkills.Riding, DefaultSkills.Steward }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, UrbanPoorAdolescenceOnCondition, UrbanAdolescenceHorserOnConsequence, UrbanAdolescenceDockerOnApply, new("{=csUq1RCC}You handled the steeds of travelers and knights, preparing them for long journeys and fierce battles, and learning the bond between rider and mount."), null, 0, 0, 0, 0, 0);
        ...
        protected new void AddYouthMenu(CharacterCreation characterCreation)
        {
            ...
            // Harad
            CharacterCreationCategory characterCreationCategory = characterCreationMenu.AddMenuCategory(new(AseraiParentsOnCondition));

            characterCreationCategory.AddCategoryOption(new("{=youth_harad_1}trained with the war elephants.", null), new()
            {
                DefaultSkills.Riding,
                DefaultSkills.Polearm
            }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCavalryOnConsequence), new(YouthCavalryOnApply), new("{=youth_harad_desc_1}You trained alongside Harad's mighty war elephants, learning to wield the spear while perched atop these towering beasts. Your skill earned you a place among the elite elephant riders, a fearsome force in battle.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=youth_harad_2}guarded the city walls.", null), new()
            {
                DefaultSkills.Crossbow,
                DefaultSkills.Engineering
            }, DefaultCharacterAttributes.Intelligence, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthGarrisonOnConsequence), new(YouthGarrisonOnApply), new("{=youth_harad_desc_2}You served as a sentinel on the fortified walls of Harad's desert cities, honing your skills with crossbows and maintaining the intricate defenses that protected your people from invaders.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=youth_harad_3}rode with the desert outriders.", null), new()
            {
                DefaultSkills.Riding,
                DefaultSkills.Bow
            }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthOtherOutridersOnConsequence), new(YouthOtherOutridersOnApply), new("{=youth_harad_desc_3}You joined Harad's swift outriders, scouting the vast deserts and harassing enemy flanks with your deadly bow and quick reflexes.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=youth_harad_4}trained with the spearmen.", null), new()
            {
                DefaultSkills.Polearm,
                DefaultSkills.OneHanded
            }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, null, new(YouthInfantryOnApply), new("{=youth_harad_desc_4}You trained as a spearman, one of the steadfast warriors of Harad who form the backbone of its armies, defending against cavalry and holding the line in fierce desert battles.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=youth_harad_5}joined the skirmishers.", null), new()
            {
                DefaultSkills.Throwing,
                DefaultSkills.OneHanded
            }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthSkirmisherOnConsequence), new(YouthSkirmisherOnApply), new("{=youth_harad_desc_5}You fought as a skirmisher, using javelins to harry the enemy from a distance, relying on your speed and agility to evade their counterattacks.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=youth_harad_6}marched with the nomadic clans.", null), new()
            {
                DefaultSkills.Roguery,
                DefaultSkills.Throwing
            }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCamperOnConsequence), new(YouthCamperOnApply), new("{=youth_harad_desc_6}You traveled with the nomadic clans of Harad, learning to survive in the harsh desert environment. Their cunning and resourcefulness became your own.", null), null, 0, 0, 0, 0, 0);

            // Khand
            characterCreationCategory = characterCreationMenu.AddMenuCategory(new(BattanianParentsOnCondition));
            characterCreationCategory.AddCategoryOption(new("{=lotraom_khand_youth_1}Trained with the Kheshig Guard."), new()
            {
                DefaultSkills.Riding,
                DefaultSkills.Polearm
            }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCavalryOnConsequence), new(YouthCavalryOnApply), new("{=lotraom_khand_youth_desc_1}As one of the most promising riders, you were chosen to train with the Kheshig, the elite mounted guard of the Khandish chieftains. With a lance in hand and a steed beneath you, you learned the art of disciplined cavalry combat.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategory.AddCategoryOption(new("{=lotraom_khand_youth_2}Joined the Wall-Watchers."), new()
            {
                DefaultSkills.Crossbow,
                DefaultSkills.Engineering
            }, DefaultCharacterAttributes.Intelligence, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthGarrisonOnConsequence), new(YouthGarrisonOnApply), new("{=lotraom_khand_youth_desc_2}Stationed at the fortified encampments along the borders, you became a Wall-Watcher. Your duties included mastering the crossbow and maintaining the defenses that kept your people safe from invaders.", null), null, 0, 0, 0, 0, 0);
            ...
            characterCreationCategory.AddCategoryOption(new("{=lotraom_khand_youth_4}Trained with the Ashkat Warriors."), new()
            {
                DefaultSkills.Polearm,
                DefaultSkills.OneHanded
            }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, null, new(YouthInfantryOnApply), new("{=lotraom_khand_youth_desc_4}As a recruit of the Ashkat Warriors, you were equipped with spear and shield, joining the ranks of the Khandish infantry. These hardened fighters form the backbone of the Khandish armies, renowned for their unyielding discipline and strength.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategory.AddCategoryOption(new("{=lotraom_khand_youth_5}Joined the Shadow Riders."), new()
            {
                DefaultSkills.Roguery,
                DefaultSkills.Throwing
            }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCamperOnConsequence), new(YouthCamperOnApply), new("{=lotraom_khand_youth_desc_5}The Shadow Riders are masters of deception and infiltration, often acting as spies and saboteurs. You learned to blend into enemy camps and settlements, using trickery, disguise, and cunning to gather intelligence and sow chaos.", null), null, 0, 0, 0, 0, 0);

            // Dunland
            characterCreationCategory = characterCreationMenu.AddMenuCategory(new(EmpireParentsOnCondition));

            characterCreationCategory.AddCategoryOption(new("{=lotraom_dunland_youth_1}Rode with the Hill Riders."), new()
            {
                DefaultSkills.Riding,
                DefaultSkills.Polearm
            }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCavalryOnConsequence), new(YouthCavalryOnApply), new("{=lotraom_dunland_youth_desc_1}Mounted on sturdy hill ponies, you joined the Hill Riders, a rare but fierce cavalry force among the Dunlendings. Armed with spear and shield, you learned to navigate the rugged terrain with precision and strength.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_dunland_youth_2}Served in the Tribal Longhouse."), new()
            {
                DefaultSkills.Crossbow,
                DefaultSkills.Engineering
            }, DefaultCharacterAttributes.Intelligence, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthGarrisonOnConsequence), new(YouthGarrisonOnApply), new("{=lotraom_dunland_youth_desc_2}Within the tribal longhouses, you helped guard your people’s stockpiles and crafted defenses for the village. Your skill with crossbows and constructing fortifications became invaluable during raids and sieges.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_dunland_youth_3}Stood guard with the Border Watch."), new()
            {
                DefaultSkills.Throwing,
                DefaultSkills.OneHanded
            }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthSkirmisherOnConsequence), new(YouthSkirmisherOnApply), new("{=lotraom_dunland_youth_desc_3}You joined the Border Watch, a group of young warriors tasked with defending Dunland’s borders. Armed with javelins and axes, you learned to strike swiftly and retreat before the enemy could retaliate.", null), null, 0, 0, 0, 0, 0);
            ...
            characterCreationCategory.AddCategoryOption(new("{=lotraom_dunland_youth_5}Joined the Spear Brothers."), new()
            {
                DefaultSkills.Polearm,
                DefaultSkills.OneHanded
            }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, null, new(YouthInfantryOnApply), new("{=lotraom_dunland_youth_desc_5}You became one of the Spear Brothers, a close-knit band of fighters armed with spears and shields. Drawn from the ranks of farmers and herdsmen, they form the heart of Dunland’s infantry, known for their ferocity and endurance.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_dunland_youth_6}Trained as a Tribal Skirmisher."), new()
            {
                DefaultSkills.Roguery,
                DefaultSkills.Throwing
            }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCamperOnConsequence), new(YouthCamperOnApply), new("{=lotraom_dunland_youth_desc_6}As a Tribal Skirmisher, you learned the art of hit-and-run tactics, striking quickly with thrown weapons and melting into the terrain. Your cunning and agility were critical in harassing enemy forces.", null), null, 0, 0, 0, 0, 0);

            // Rohan
            characterCreationCategory = characterCreationMenu.AddMenuCategory(new(VlandianParentsOnCondition));

            characterCreationCategory.AddCategoryOption(new("{=lotraom_rohan_youth_1}Trained with the Riders of the Mark."), new()
            {
                DefaultSkills.Riding,
                DefaultSkills.Polearm
            }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCavalryOnConsequence), new(YouthCavalryOnApply), new("{=lotraom_rohan_youth_desc_1}You proved your skill as a rider, earning the trust of a local marshal who lent you a horse and spear. You trained with the Riders of the Mark, learning to charge into battle with precision and discipline.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_rohan_youth_2}Served in the city watch of Edoras."), new()
            {
                DefaultSkills.Crossbow,
                DefaultSkills.Engineering
            }, DefaultCharacterAttributes.Intelligence, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthGarrisonOnConsequence), new(YouthGarrisonOnApply), new("{=lotraom_rohan_youth_desc_2}You stood guard over the gates and walls of Edoras, keeping a watchful eye on the horizon for approaching enemies. You honed your skills with missile weapons and learned the art of fortification.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_rohan_youth_3}Joined the skirmishers of the Westfold."), new()
            {
                DefaultSkills.Throwing,
                DefaultSkills.OneHanded
            }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthSkirmisherOnConsequence), new(YouthSkirmisherOnApply), new("{=lotraom_rohan_youth_desc_3}You joined the Westfold skirmishers, a band of agile warriors skilled in harassing the enemy with javelins and close-quarters combat. You learned to stay nimble and strike swiftly.", null), null, 0, 0, 0, 0, 0);
            ...
            characterCreationCategory.AddCategoryOption(new("{=lotraom_rhun_youth_5}Fought with the spear line."), new()
            {
                DefaultSkills.Polearm,
                DefaultSkills.OneHanded
            }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthInfantryOnConsequence), new(YouthInfantryOnApply), new("{=lotraom_rhun_youth_desc_5}Standing shoulder to shoulder with your kin, you fought in the spear line, the backbone of Rhûn’s armies. With your spear and shield, you defended your homeland against all who dared threaten it.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_rhun_youth_6}Traveled with the Karash bands."), new()
            {
                DefaultSkills.Roguery,
                DefaultSkills.Throwing
            }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCamperOnConsequence), new(YouthCamperOnApply), new("{=lotraom_rhun_youth_desc_6}You avoided direct service in the armies of Rhûn, instead joining the Karash bands—nomadic groups of traders, entertainers, and survivalists who supported the war effort through unconventional means.", null), null, 0, 0, 0, 0, 0);

            // Dale
            characterCreationCategory = characterCreationMenu.AddMenuCategory(new(SturgianParentsOnCondition));

            characterCreationCategory.AddCategoryOption(new("{=lotraom_dale_youth_1}Served in the Royal Guard of Dale."), new()
            {
                DefaultSkills.Riding,
                DefaultSkills.Polearm
            }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCavalryOnConsequence), new(YouthCavalryOnApply), new("{=lotraom_dale_youth_desc_1}You pledged your loyalty to the King of Dale, serving as a guard in his elite mounted retinue. Equipped with a fine steed and a sturdy lance, you trained to protect the royal court.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_dale_youth_2}Defended the gates of Dale."), new()
            {
                DefaultSkills.Crossbow,
                DefaultSkills.Engineering
            }, DefaultCharacterAttributes.Intelligence, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthGarrisonOnConsequence), new(YouthGarrisonOnApply), new("{=lotraom_dale_youth_desc_2}As a member of the garrison, you stood watch over the gates and walls of Dale. You trained with crossbows and siege engines to prepare for attacks on the city.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_dale_youth_3}Trained with the infantry of Dale."), new()
            {
                DefaultSkills.Throwing,
                DefaultSkills.OneHanded
            }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthSkirmisherOnConsequence), new(YouthSkirmisherOnApply), new("{=lotraom_dale_youth_desc_3}You joined the ranks of Dale’s infantry, where you learned to fight with throwing axes and short blades. Quick and light-footed, you harassed enemies from a distance and supported the main lines.", null), null, 0, 0, 0, 0, 0);
            ...
            characterCreationCategory.AddCategoryOption(new("{=lotraom_dale_youth_5}Joined the shieldwall."), new()
            {
                DefaultSkills.Polearm,
                DefaultSkills.OneHanded
            }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthInfantryOnConsequence), new(YouthInfantryOnApply), new("{=lotraom_dale_youth_desc_5}You took your place in Dale’s shieldwall, the backbone of the city’s defenses. Armed with a spear and shield, you stood firm against the enemy’s advance.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_dale_youth_6}Traveled with the merchant caravans."), new()
            {
                DefaultSkills.Roguery,
                DefaultSkills.Throwing
            }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCamperOnConsequence), new(YouthCamperOnApply), new("{=lotraom_dale_youth_desc_6}You avoided direct military service, choosing instead to accompany merchant caravans as they crossed the Wilderland. You learned to defend yourself and negotiate with traders, rogues, and bandits alike.", null), null, 0, 0, 0, 0, 0);
            ...
            characterCreationCategory.AddCategoryOption(new("{=lotraom_mordor_youth_1}Trained with the Warg Riders."), new()
            {
                DefaultSkills.Riding,
                DefaultSkills.Polearm
            }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCavalryOnConsequence), new(YouthCavalryOnApply), new("{=lotraom_mordor_youth_desc_1}You were chosen to train with the elite Warg Riders, learning to master the ferocious beasts and wield a spear in devastating charges against Mordor's enemies.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_mordor_youth_2}Patrolled the dark fortresses."), new()
            {
                DefaultSkills.Crossbow,
                DefaultSkills.Engineering
            }, DefaultCharacterAttributes.Intelligence, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthGarrisonOnConsequence), new(YouthGarrisonOnApply), new("{=lotraom_mordor_youth_desc_2}You served as a watchman on the towers and walls of Mordor’s fortresses, honing your skills with crossbows and preparing siege engines for inevitable war.", null), null, 0, 0, 0, 0, 0);
            ...
            characterCreationCategory.AddCategoryOption(new("{=lotraom_mordor_youth_4}Trained with the Orc Infantry."), new()
            {
                DefaultSkills.Polearm,
                DefaultSkills.OneHanded
            }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, null, new(YouthInfantryOnApply), new("{=lotraom_mordor_youth_desc_4}You marched among the Orc infantry, wielding crude but effective weapons and forming the relentless backbone of Mordor’s war machine.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_mordor_youth_5}Joined the Shadow Skirmishers."), new()
            {
                DefaultSkills.Throwing,
                DefaultSkills.OneHanded
            }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthSkirmisherOnConsequence), new(YouthSkirmisherOnApply), new("{=lotraom_mordor_youth_desc_5}You became a Shadow Skirmisher, throwing jagged projectiles and darting in and out of battle to harry the enemy’s flanks.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_mordor_youth_6}Marched with the war host."), new()
            {
                DefaultSkills.Roguery,
                DefaultSkills.Throwing
            }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCamperOnConsequence), new(YouthCamperOnApply), new("{=lotraom_mordor_youth_desc_6}You avoided the front lines, instead joining the war host’s camp followers who supplied, scavenged, and supported the Dark Lord's forces in unconventional ways.", null), null, 0, 0, 0, 0, 0);
            ...
            characterCreationCategory.AddCategoryOption(new("{=lotraom_rivendell_youth_4}Trained in the art of Elven infantry."), new()
            {
                DefaultSkills.Polearm,
                DefaultSkills.OneHanded
            }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthInfantryOnConsequence), new(YouthInfantryOnApply), new("{=lotraom_rivendell_youth_desc_4}You stood with the ranks of Rivendell’s warriors, learning to master the spear and sword. The disciplined formation of your comrades inspired your determination.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_rivendell_youth_5}Journeyed with the loremasters."), new()
            {
                DefaultSkills.Charm,
                DefaultSkills.Leadership
            }, DefaultCharacterAttributes.Social, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCamperOnConsequence), new(YouthCamperOnApply), new("{=lotraom_rivendell_youth_desc_5}You accompanied Rivendell’s loremasters as they traveled across Middle-earth, spreading wisdom and forging alliances. You learned the subtleties of diplomacy and persuasion.", null), null, 0, 0, 0, 0, 0);
            ...
            characterCreationCategory.AddCategoryOption(new("{=lotraom_mirkwood_youth_1}Trained with the Woodland Riders."), new()
            {
                DefaultSkills.Riding,
                DefaultSkills.Bow
            }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCavalryOnConsequence), new(YouthCavalryOnApply), new("{=lotraom_mirkwood_youth_desc_1}You rode through the dark woods, honing your skill as an archer on horseback. You were the swift protectors of the Woodland Realm.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_mirkwood_youth_2}Patrolled the darkened glades."), new()
            {
                DefaultSkills.Scouting,
                DefaultSkills.OneHanded
            }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthGarrisonOnConsequence), new(YouthGarrisonOnApply), new("{=lotraom_mirkwood_youth_desc_2}You joined the wardens who patrolled the glades of Mirkwood, keeping watch for spiders and darker shadows. Your agility and vigilance served you well.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_mirkwood_youth_3}Stood with the Elven Spear Guard."), new()
            {
                DefaultSkills.Polearm,
                DefaultSkills.Tactics
            }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthInfantryOnConsequence), new(YouthInfantryOnApply), new("{=lotraom_mirkwood_youth_desc_3}You took your place among the Spear Guard, protecting the Woodland King’s halls from threats both seen and unseen.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_mirkwood_youth_4}Joined the shadow trackers."), new()
            {
                DefaultSkills.Roguery,
                DefaultSkills.Throwing
            }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCamperOnConsequence), new(YouthCamperOnApply), new("{=lotraom_mirkwood_youth_desc_4}You were among those tasked with tracking the movements of orcs and other foul creatures in the shadows of Mirkwood. Your cunning and adaptability ensured your survival.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_mirkwood_youth_5}Marched with the royal banners."), new()
            {
                DefaultSkills.Charm,
                DefaultSkills.Leadership
            }, DefaultCharacterAttributes.Social, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCamperOnConsequence), new(YouthCamperOnApply), new("{=lotraom_mirkwood_youth_desc_5}You joined the royal court as part of the Woodland King’s entourage, learning diplomacy and leadership among the Elven nobility.", null), null, 0, 0, 0, 0, 0);
            ...
            characterCreationCategory.AddCategoryOption(new("{=lotraom_lothlorien_youth_1}Trained with the Galadhrim cavalry."), new()
            {
                DefaultSkills.Riding,
                DefaultSkills.Polearm
            }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCavalryOnConsequence), new(YouthCavalryOnApply), new("{=lotraom_lothlorien_youth_desc_1}You joined the elite cavalry of Lothlórien, protecting the Golden Wood. You became adept with the lance, defending the borders against intrusions.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_lothlorien_youth_2}Guarded the golden borders."), new()
            {
                DefaultSkills.Bow,
                DefaultSkills.Scouting
            }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthGarrisonOnConsequence), new(YouthGarrisonOnApply), new("{=lotraom_lothlorien_youth_desc_2}You patrolled the borders of the Golden Wood, ensuring that no unwelcome foot entered its sacred grounds. Your skill with a bow was critical in defending against dark forces.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_lothlorien_youth_3}Joined the archers of Caras Galadhon."), new()
            {
                DefaultSkills.Bow,
                DefaultSkills.Tactics
            }, DefaultCharacterAttributes.Intelligence, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthSkirmisherOnConsequence), new(YouthSkirmisherOnApply), new("{=lotraom_lothlorien_youth_desc_3}You trained with the famed archers of Lothlórien, learning how to strike swiftly and retreat to cover, leaving the enemy in disarray.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_lothlorien_youth_4}Joined the wardens of the trees."), new()
            {
                DefaultSkills.Polearm,
                DefaultSkills.OneHanded
            }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthInfantryOnConsequence), new(YouthInfantryOnApply), new("{=lotraom_lothlorien_youth_desc_4}You became a warden of the trees, standing guard beneath the towering mallorn trees. Your strength and steadfastness ensured the safety of Lórien’s heart.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_lothlorien_youth_5}Marched with the singers of tales."), new()
            {
                DefaultSkills.Charm,
                DefaultSkills.Roguery
            }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCamperOnConsequence), new(YouthCamperOnApply), new("{=lotraom_lothlorien_youth_desc_5}You traveled with the singers of tales, sharing the stories of the Eldar and spreading hope. You learned the art of persuasion and subtlety during your journeys.", null), null, 0, 0, 0, 0, 0);
            ...
            }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthInfantryOnConsequence), new(YouthInfantryOnApply), new("{=lotraom_erebor_youth_desc_5}You trained as part of Erebor’s vanguard, wielding massive warhammers and halberds. Standing firm at the front lines, you were a bulwark against any assault.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_erebor_youth_6}Worked with the caravan guards."), new()
            {
                DefaultSkills.Roguery,
                DefaultSkills.Trade
            }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCamperOnConsequence), new(YouthCamperOnApply), new("{=lotraom_erebor_youth_desc_6}You accompanied trading caravans laden with Erebor’s treasures, ensuring their safe passage through the Wilderland. You learned the ways of merchants, as well as how to fend off thieves and raiders.", null), null, 0, 0, 0, 0, 0);
            ...
            characterCreationCategory.AddCategoryOption(new("{=lotraom_isengard_youth_1}Joined Saruman's cavalry."), new()
            {
                DefaultSkills.Riding,
                DefaultSkills.Polearm
            }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCavalryOnConsequence), new(YouthCavalryOnApply), new("{=lotraom_isengard_youth_desc_1}You trained as a rider for Saruman's forces, patrolling the lands surrounding Isengard and engaging in skirmishes with Rohan.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_isengard_youth_2}Guarded the pits of Orthanc."), new()
            {
                DefaultSkills.Crossbow,
                DefaultSkills.Engineering
            }, DefaultCharacterAttributes.Intelligence, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthGarrisonOnConsequence), new(YouthGarrisonOnApply), new("{=lotraom_isengard_youth_desc_2}You were stationed at Orthanc, guarding the forges and machinery that fueled Saruman’s war effort. Your skill with ranged weapons and siege equipment was honed in preparation for battle.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_isengard_youth_3}Fought among the Uruk-hai infantry."), new()
            {
                DefaultSkills.Throwing,
                DefaultSkills.OneHanded
            }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthSkirmisherOnConsequence), new(YouthSkirmisherOnApply), new("{=lotraom_isengard_youth_desc_3}You trained with the ferocious Uruk-hai, learning to fight with brutal efficiency. Your skill with thrown weapons and close combat earned you respect among your kin.", null), null, 0, 0, 0, 0, 0);
            ...
            characterCreationCategory.AddCategoryOption(new("{=lotraom_isengard_youth_5}Joined the ranks of Isengard's pikes."), new()
            {
                DefaultSkills.Polearm,
                DefaultSkills.Tactics
            }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthInfantryOnConsequence), new(YouthInfantryOnApply), new("{=lotraom_isengard_youth_desc_5}You became a member of Isengard’s formidable pikemen, known for their discipline and ability to hold the line against cavalry charges.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_isengard_youth_6}Marched with Saruman's warbands."), new()
            {
                DefaultSkills.Roguery,
                DefaultSkills.Throwing
            }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCamperOnConsequence), new(YouthCamperOnApply), new("{=lotraom_isengard_youth_desc_6}You traveled with Isengard’s warbands, raiding villages and sowing fear among the Free Peoples. You learned to survive on plunder and cunning.", null), null, 0, 0, 0, 0, 0);
            ...
            characterCreationCategory.AddCategoryOption(new("{=lotraom_gundabad_youth_1}Joined the Warg riders."), new()
            {
                DefaultSkills.Riding,
                DefaultSkills.Polearm
            }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCavalryOnConsequence), new(YouthCavalryOnApply), new("{=lotraom_gundabad_youth_desc_1}You rode with the Warg riders of Gundabad, striking terror into the hearts of your enemies with swift and deadly raids.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_gundabad_youth_2}Guarded the forges of Gundabad."), new()
            {
                DefaultSkills.Crossbow,
                DefaultSkills.Engineering
            }, DefaultCharacterAttributes.Intelligence, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthGarrisonOnConsequence), new(YouthGarrisonOnApply), new("{=lotraom_gundabad_youth_desc_2}You served in the garrison of Gundabad, defending the dark halls and the forges that armed its legions.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_gundabad_youth_3}Trained with the berserkers."), new()
            {
                DefaultSkills.TwoHanded,
                DefaultSkills.Athletics
            }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthInfantryOnConsequence), new(YouthInfantryOnApply), new("{=lotraom_gundabad_youth_desc_3}You were among the berserkers of Gundabad, wielding massive weapons with unrelenting ferocity to crush your foes.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_gundabad_youth_4}Scouted the mountain passes."), new()
            {
                DefaultSkills.Scouting,
                DefaultSkills.Bow
            }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthOtherOutridersOnConsequence), new(YouthOtherOutridersOnApply), new("{=lotraom_gundabad_youth_desc_4}You roamed the treacherous mountain paths of Gundabad, watching for intruders and ambushing unwary travelers.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_gundabad_youth_5}Joined the spear legions."), new()
            {
                DefaultSkills.Polearm,
                DefaultSkills.Tactics
            }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthInfantryOnConsequence), new(YouthInfantryOnApply), new("{=lotraom_gundabad_youth_desc_5}You marched with the disciplined spear legions of Gundabad, ready to pierce through any defense.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_gundabad_youth_6}Marched with the warbands."), new()
            {
                DefaultSkills.Roguery,
                DefaultSkills.Throwing
            }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCamperOnConsequence), new(YouthCamperOnApply), new("{=lotraom_gundabad_youth_desc_6}You followed the warbands of Gundabad, pillaging and striking fear into the lands of men and elves.", null), null, 0, 0, 0, 0, 0);
            ...
            characterCreationCategory.AddCategoryOption(new("{=lotraom_dolguldur_youth_1}Served the Necromancer's riders."), new()
            {
                DefaultSkills.Riding,
                DefaultSkills.Polearm
            }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCavalryOnConsequence), new(YouthCavalryOnApply), new("{=lotraom_dolguldur_youth_desc_1}You rode in the service of Dol Guldur, spreading terror across the lands of Rhovanion with swift and brutal attacks.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_dolguldur_youth_2}Guarded the halls of shadow."), new()
            {
                DefaultSkills.Crossbow,
                DefaultSkills.Engineering
            }, DefaultCharacterAttributes.Intelligence, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthGarrisonOnConsequence), new(YouthGarrisonOnApply), new("{=lotraom_dolguldur_youth_desc_2}You defended the dark halls of Dol Guldur, ensuring the stronghold's defenses remained impenetrable.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_dolguldur_youth_3}Trained in the dark arts of war."), new()
            {
                DefaultSkills.OneHanded,
                DefaultSkills.Tactics
            }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthInfantryOnConsequence), new(YouthInfantryOnApply), new("{=lotraom_dolguldur_youth_desc_3}You honed your skills in the dark arts of warfare, learning to fight with cunning and ruthlessness.", null), null, 0, 0, 0, 0, 0);
            ...
            characterCreationCategory.AddCategoryOption(new("{=lotraom_dolguldur_youth_5}Joined the shadow legions."), new()
            {
                DefaultSkills.Polearm,
                DefaultSkills.TwoHanded
            }, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthInfantryOnConsequence), new(YouthInfantryOnApply), new("{=lotraom_dolguldur_youth_desc_5}You marched under the banners of shadow, wielding dark weapons to crush your enemies.", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=lotraom_dolguldur_youth_6}Lurked in the shadows."), new()
            {
                DefaultSkills.Roguery,
                DefaultSkills.Throwing
            }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, new(YouthCamperOnConsequence), new(YouthCamperOnApply), new("{=lotraom_dolguldur_youth_desc_6}You avoided open combat, working instead in secret to undermine the forces of light with cunning and deception.", null), null, 0, 0, 0, 0, 0);
        ...
        private void LOTRAOMYouthOnInit(CharacterCreation characterCreation)
        {
            ...
            characterCreation.ChangeFaceGenChars(ChangePlayerFaceWithAge(YouthAge, "act_childhood_schooled"));
            characterCreation.ChangeCharsAnimation(new List<string>
            {
                "act_childhood_schooled"
            });
            if (SelectedTitleType < 1 || SelectedTitleType > 10)
            {
                SelectedTitleType = 1;
            }
        ...
        protected new void AddAdulthoodMenu(CharacterCreation characterCreation)
        {
            ...
            CharacterCreationMenu characterCreationMenu = new(new("{=MafIe9yI}Young Adulthood", null), new("{=4WYY0X59}Before you set out for a life of adventure, your biggest achievement was...", null), new CharacterCreationOnInit(AccomplishmentOnInit), CharacterCreationMenu.MenuTypes.MultipleChoice);
            ...
            characterCreationCategory.AddCategoryOption(new("{=mP3uFbcq}you led a successful manhunt.", null), new()
            {
                DefaultSkills.Tactics,
                DefaultSkills.Leadership
            }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, new(AccomplishmentPosseOnConditions), new(AccomplishmentExpeditionOnConsequence), new(AccomplishmentExpeditionOnApply), new("{=4f5xwzX0}When your community needed to organize a posse to pursue horse thieves, you were the obvious choice. You hunted down the raiders, surrounded them and forced their surrender, and took back your stolen property.", null), new()
            {
            ...
            characterCreationCategory.AddCategoryOption(new("{=wfbtS71d}you led a caravan.", null), new()
            {
                DefaultSkills.Tactics,
                DefaultSkills.Leadership
            }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, new(AccomplishmentMerchantOnCondition), new(AccomplishmentMerchantOnConsequence), new(AccomplishmentExpeditionOnApply), new("{=joRHKCkm}Your family needed someone trustworthy to take a caravan to a neighboring town. You organized supplies, ensured a constant watch to keep away bandits, and brought it safely to its destination.", null), new()
            {
                DefaultTraits.Calculating
            }, 1, 10, 0, 0, 0);
            ...
            characterCreationCategory.AddCategoryOption(new("{=x1HTX5hq}you saved your village from a flood.", null), new()
            {
                DefaultSkills.Tactics,
                DefaultSkills.Leadership
            }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, new(AccomplishmentSavedVillageOnCondition), new(AccomplishmentSavedVillageOnConsequence), new(AccomplishmentExpeditionOnApply), new("{=bWlmGDf3}When a sudden storm caused the local stream to rise suddenly, your neighbors needed quick-thinking leadership. You provided it, directing them to build levees to save their homes.", null), new()
            {
                DefaultTraits.Calculating
            }, 1, 10, 0, 0, 0);
            ...
            characterCreationCategory.AddCategoryOption(new("{=s8PNllPN}you saved your city quarter from a fire.", null), new()
            {
                DefaultSkills.Tactics,
                DefaultSkills.Leadership
            }, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, new(AccomplishmentSavedStreetOnCondition), new(AccomplishmentSavedStreetOnConsequence), new(AccomplishmentExpeditionOnApply), new("{=ZAGR6PYc}When a sudden blaze broke out in a back alley, your neighbors needed quick-thinking leadership and you provided it. You organized a bucket line to the nearest well, putting the fire out before any homes were lost.", null), new()
            {
                DefaultTraits.Calculating
            }, 1, 10, 0, 0, 0);
            ...
            }, DefaultCharacterAttributes.Intelligence, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, new(AccomplishmentUrbanOnCondition), new(AccomplishmentWorkshopOnConsequence), new(AccomplishmentWorkshopOnApply), new("{=PyVqDLBu}Your parents didn't give you much money, but they did leave just enough for you to secure a loan against a larger amount to build a small workshop. You paid back what you borrowed, and sold your enterprise for a profit.", null), new()
            {
                DefaultTraits.Calculating
            }, 1, 10, 0, 0, 0);
            ...
            characterCreationCategory.AddCategoryOption(new("{=xKXcqRJI}you invested some money in land.", null), new()
            {
                DefaultSkills.Trade,
                DefaultSkills.Crafting
            }, DefaultCharacterAttributes.Intelligence, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, new(AccomplishmentRuralOnCondition), new(AccomplishmentWorkshopOnConsequence), new(AccomplishmentWorkshopOnApply), new("{=cbF9jdQo}Your parents didn't give you much money, but they did leave just enough for you to purchase a plot of unused land at the edge of the village. You cleared away rocks and dug an irrigation ditch, raised a few seasons of crops, than sold it for a considerable profit.", null), new()
            {
                DefaultTraits.Calculating
            }, 1, 10, 0, 0, 0);
            ...
            characterCreationCategory.AddCategoryOption(new("{=TbNRtUjb}you hunted a dangerous animal.", null), new()
            {
                DefaultSkills.Polearm,
                DefaultSkills.Crossbow
            }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, new(AccomplishmentRuralOnCondition), new(AccomplishmentSiegeHunterOnConsequence), new(AccomplishmentSiegeHunterOnApply), new("{=I3PcdaaL}Wolves, bears are a constant menace to the flocks of northern Athas, while hyenas and leopards trouble the south. You went with a group of your fellow villagers and fired the missile that brought down the beast.", null), null, 0, 5, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=WbHfGCbd}you survived a siege.", null), new()
            {
                DefaultSkills.Bow,
                DefaultSkills.Crossbow
            }, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, new(AccomplishmentUrbanOnCondition), new(AccomplishmentSiegeHunterOnConsequence), new(AccomplishmentSiegeHunterOnApply), new("{=FhZPjhli}Your hometown was briefly placed under siege, and you were called to defend the walls. Everyone did their part to repulse the enemy assault, and everyone is justly proud of what they endured.", null), null, 0, 5, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new("{=kNXet6Um}you had a famous escapade in town.", null), new()
            {
                DefaultSkills.Athletics,
                DefaultSkills.Roguery
            }, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, new(AccomplishmentRuralOnCondition), new(AccomplishmentEscapadeOnConsequence), new(AccomplishmentEscapadeOnApply), new("{=DjeAJtix}Maybe it was a love affair, or maybe you cheated at dice, or maybe you just chose your words poorly when drinking with a dangerous crowd. Anyway, on one of your trips into town you got into the kind of trouble from which only a quick tongue or quick feet get you out alive.", null), new()
            {
                DefaultTraits.Valor
            }, 1, 5, 0, 0, 0);
        ...
        {
            return GetSelectedCulture().StringId == "gondor";
        }
        protected bool MordorParentsOnCondition()
        {
            return GetSelectedCulture().StringId == "mordor";
        }

        protected bool RivendellParentsOnCondition()
        {
            return GetSelectedCulture().StringId == "rivendell";
        }
        protected bool MirkwoodParentsOnCondition()
        {
            return GetSelectedCulture().StringId == "mirkwood";
        }

        protected bool LothlorienParentsOnCondition()
        {
            return GetSelectedCulture().StringId == "lothlorien";
        }
        protected bool EreborParentsOnCondition()
        {
            return GetSelectedCulture().StringId == "erebor";
        }
        protected bool IsengardParentsOnCondition()
        {
            return GetSelectedCulture().StringId == "isengard";
        }
        protected bool GundabadParentsOnCondition()
        {
            return GetSelectedCulture().StringId == "gundabad";
        }
        protected bool DolguldurParentsOnCondition()
        {
            return GetSelectedCulture().StringId == "dolguldur";
        }
        protected bool UmbarParentsOnCondition()
        {
            return GetSelectedCulture().StringId == "umbar";
        }
